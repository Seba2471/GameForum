...
using GameForum.Infrastructure.Security.Manager;
using GameForum.Infrastructure.Security.Models;
using GameForum.Infrastructure.Security.Services;
...
{
    public static class ApplicationSecurityServiceExtensions
    {
